...
/*
    you must modify this to point to the correct script
*/
var __sdmx_proxy_host = "http://localhost/sdmx-rest-doc";
...
$(document).ready( function() {
    ...
    SDMX = {
        _defaultValues: {
            proxy: __sdmx_proxy_host + "/proxy.php?url=",
            ...
            $.get(url,
                function(data) {
                    ...
                    $.each( json.DataSet[0].Series[0].Obs, function(i, e) {
                        series.push(parseFloat(e.OBS_VALUE));
                    });
                    $("#" + id).sparkline( series );
                }
            );
